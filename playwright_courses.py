...
with sync_playwright() as playwright:
    ...
    empty_courses_list_title = page.get_by_test_id("courses-list-empty-view-title-text")
    ...
    empty_courses_list_text = page.get_by_test_id("courses-list-empty-view-description-text")
